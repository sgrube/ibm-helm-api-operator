...
NAMESPACE=ibm-helm-api-operator
...
BASE_DIR := ibm-helm-api-operator
...
generate-csv: ## Generate CSV
	...
	@cp deploy/crds/operator.ibm.com_helmapis_crd.yaml deploy/olm-catalog/$(NAMESPACE)/$(CSV_VERSION)/

push-csv: ## Push CSV package to the helm-api
...
install: ## Install all resources (CR/CRD's, RBCA and Operator)
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_helmapis_crd.yaml
	@echo ....... Applying RBAC .......
	...
	- kubectl apply -f deploy/crds/operator.ibm.com_v1alpha1_helmapi_cr.yaml -n ${NAMESPACE}

uninstall: ## Uninstall all that all performed in the $ make install
	@echo ....... Uninstalling .......
	@echo ....... Deleting CR .......
	- kubectl delete -f deploy/crds/operator.ibm.com_v1alpha1_helmapi_cr.yaml -n ${NAMESPACE}
	@echo ....... Deleting Operator .......
	- kubectl delete -f deploy/operator.yaml -n ${NAMESPACE}
	@echo ....... Deleting CRDs.......
	- kubectl delete -f deploy/crds/operator.ibm.com_helmapi_crd.yaml
